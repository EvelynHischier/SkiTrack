 ...
 * on 2014-12-12 at 12:37:00 UTC 
 * Modify at your own risk.
 */

package ch.technotracks.backend.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends UserApiRequest<ch.technotracks.backend.userApi.model.User> {
    ...
    protected Get(java.lang.Long id) {
      super(UserApi.this, "GET", REST_PATH, null, ch.technotracks.backend.userApi.model.User.class);
   ...
   *
   * @param content the {@link ch.technotracks.backend.userApi.model.User}
   * @return the request
   */
  public Insert insert(ch.technotracks.backend.userApi.model.User content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<ch.technotracks.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(ch.technotracks.backend.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, ch.technotracks.backend.userApi.model.User.class);
    }
  ...
  public class List extends UserApiRequest<ch.technotracks.backend.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, ch.technotracks.backend.userApi.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.Long id, ch.technotracks.backend.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(id, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<ch.technotracks.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long id, ch.technotracks.backend.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, ch.technotracks.backend.userApi.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long id, ch.technotracks.backend.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(id, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<ch.technotracks.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long id, ch.technotracks.backend.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, ch.technotracks.backend.userApi.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
